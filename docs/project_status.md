...
**Last Updated:** September 2, 2026 (v3.1.0 — the evidence layer: inferred engineering profile, three change tiers, evidence gates with provenance, fitness-for-intended-use go-live)
...
- ✅ **Phase 15 — The Evidence Layer** (Sep 2026, v3.1.0): inferred engineering profile, questions only when warranted, ROUTINE / LOAD-BEARING / IRREVERSIBLE change tiers with deterministic triggers, evidence gates with provenance, protected governance class, content-is-data, fitness-for-intended-use go-live with the ceiling flag; executable canonical cases; kill criterion recorded
...
- Merge the current branch, then tag `v3.1.0` (match the version in `.claude-plugin/plugin.json`)
