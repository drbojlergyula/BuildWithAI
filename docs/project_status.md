...
**Last Updated:** September 3, 2026 (v3.1.5 — verified against a real shipped project: 78/78 checks reproduced, case-collision check and reproducible-numbers rule added)
...
- Merge the current branch, then tag `v3.1.5` (match the version in `.claude-plugin/plugin.json`)
