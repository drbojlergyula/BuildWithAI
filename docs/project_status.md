...
**Last Updated:** September 2, 2026 (v3.1.1 — the template now validates as a project too: mode-aware validation + project-mode eval, four real bugs fixed)
...
- Merge the current branch, then tag `v3.1.1` (match the version in `.claude-plugin/plugin.json`)
